...
class ImageStorage(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
            Метод сохранения картинки происходит в три этапа
            1) Перезапись размера с коэфицентом сжатия (коэфицент = 60%)
            2) Изменения расширения на jpg и изменение канальности на "3-канальный"
            3) Пересохранение картинки через метод save класса
        """
